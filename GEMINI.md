...
- **Maintenance**: Always maintain and update `constraints.md` in the project root to document technical limitations (like Render's memory limits) and the architectural/code changes made to address them. also ensure to update GEMINI.md to log the relevant stuff here.
